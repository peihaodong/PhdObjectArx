...
bool Phd::PhdArxUiPr::SelEnt(LPCTSTR szPrompt, AcRxClass* classType, AcDbObjectId& id, AcGePoint3d& pt)
{
	CString strPrompt;
	strPrompt.Format(_T("\n%s："),szPrompt);
	while (true)
...
int Phd::PhdArxUiPr::SelEnt2(LPCTSTR szPrompt, AcRxClass* classType,
...
bool Phd::PhdArxUiPr::SelEnt(LPCTSTR szPrompt, const AcArray<AcRxClass*>& arrclassType, AcDbObjectId& id, AcGePoint3d& pt)
{
	CString strPrompt;
	strPrompt.Format(_T("\n%s："), szPrompt);
	ads_name ent;
...
bool Phd::PhdArxUiPr::SelEnts(LPCTSTR szPrompt, const AcArray<AcRxClass*>& arrclassType, AcDbObjectIdArray& idArr)
{
	idArr.removeAll();
	CString strPrompt;
	strPrompt.Format(_T("\n%s："), szPrompt);
...
bool Phd::PhdArxUiPr::SelKey(LPCTSTR szPrompt, const std::vector<SKey>& vecKey, 
	CString& key)
{
	/*
	TCHAR szKword1[132];
...
bool Phd::PhdArxUiPr::SelKey(LPCTSTR szPrompt, const std::vector<SKey>& vecKey, CString& key, int nInitFlag)
{
	/*
	RSG_NONULL：不允许空输入
	RSG_NOZERO：不允许零值
...
bool Phd::PhdArxUiPr::GetDouble(LPCTSTR szPrompt, double& dValue)
{
	/*
	RSG_NONULL：不允许空输入
	RSG_NOZERO：不允许零值
...
bool Phd::PhdArxUiPr::GetDouble(LPCTSTR szPrompt, double& dValue, double dDefault, int nInitFlag)
{
	TCHAR defStr[512];
...
bool Phd::PhdArxUiPr::GetInt(LPCTSTR szPrompt, int& nValue)
{
	/*
	RSG_NONULL：不允许空输入
	RSG_NOZERO：不允许零值
...
bool Phd::PhdArxUiPr::GetInt(LPCTSTR szPrompt, int& nValue, int nDefault)
{
	/*
	RSG_NONULL：不允许空输入
	RSG_NOZERO：不允许零值
...
bool Phd::PhdArxUiPr::GetString(LPCTSTR szPrompt, CString& strValue)
{
	/*
	RSG_NONULL：不允许空输入
	RSG_NOZERO：不允许零值
...
bool Phd::PhdArxUiPr::GetString(LPCTSTR szPrompt, CString& strValue, int nInitFlag)
{
	/*
	RSG_NONULL：不允许空输入
	RSG_NOZERO：不允许零值
...
bool Phd::PhdArxUiPr::GetString(LPCTSTR szPrompt, CString& strValue, LPCTSTR szDefault)
{
	/*
	RSG_NONULL：不允许空输入
	RSG_NOZERO：不允许零值
...
bool Phd::PhdArxUiPr::GetPoint(LPCTSTR szPrompt, AcGePoint3d& pt)
{
	/*
	RSG_NONULL：不允许空输入
	RSG_NOZERO：不允许零值
...
bool Phd::PhdArxUiPr::GetAngle(LPCTSTR szPrompt, double& dAngle)
{
	/*
	RSG_NONULL：不允许空输入
	RSG_NOZERO：不允许零值
...
bool Phd::PhdArxUiPr::GetDist(LPCTSTR szPrompt, double& dDist)
{
	/*
	RSG_NONULL：不允许空输入
	RSG_NOZERO：不允许零值
...
bool Phd::PhdArxUiPr::GetDist(LPCTSTR szPrompt, double& dDist, const AcGePoint3d& ptBase, double dDefault)
{
	/*
	RSG_NONULL：不允许空输入
	RSG_NOZERO：不允许零值
...
bool Phd::PhdArxUiPr::GetDist(LPCTSTR szPrompt, double& dDist, const AcGePoint3d& ptBase)
{
	/*
	RSG_NONULL：不允许空输入
	RSG_NOZERO：不允许零值
...
bool Phd::PhdArxUiPr::GetDist(LPCTSTR szPrompt, double& dDist, double dDefault)
{
	/*
	RSG_NONULL：不允许空输入
	RSG_NOZERO：不允许零值
...
bool Phd::PhdArxUiPr::GetAngle(LPCTSTR szPrompt, double& dAngle, const AcGePoint3d& ptBase, double dDefault)
{
	/*
	RSG_NONULL：不允许空输入
	RSG_NOZERO：不允许零值
...
bool Phd::PhdArxUiPr::GetAngle(LPCTSTR szPrompt, double& dAngle, const AcGePoint3d& ptBase)
{
	/*
	RSG_NONULL：不允许空输入
	RSG_NOZERO：不允许零值
...
bool Phd::PhdArxUiPr::GetCorner(LPCTSTR szPrompt, const AcGePoint3d& ptBase, AcGePoint3d& pt)
{
	/*
	RSG_NONULL：不允许空输入
	RSG_NOZERO：不允许零值
...
bool Phd::PhdArxUiPr::GetAngle(LPCTSTR szPrompt, double& dAngle, double dDefault)
{
	/*
	RSG_NONULL：不允许空输入
	RSG_NOZERO：不允许零值
...
bool Phd::PhdArxUiPr::GetDouble(LPCTSTR szPrompt, double& dValue, double dDefault)
{
	/*
	RSG_NONULL：不允许空输入
	RSG_NOZERO：不允许零值
