...
void Phd::PhdArxViewport::CreateViewport()
{
...
bool Phd::PhdArxViewport::SetViewportRange(const AcGePoint3d& ptMin, const AcGePoint3d& ptMax,
...
AcDbObjectId Phd::PhdArxViewport::GetViewportId(AcDbDatabase* pDb /*= acdbCurDwg()*/)
{
...
bool Phd::PhdArxViewport::SetViewportRange(double dX, double dY, AcDbDatabase* pDb /*= acdbCurDwg()*/)
{
	AcDbObjectId idViewport = GetViewportId(pDb);
	AcDbViewportTableRecordPointer pVpTblRcd(idViewport, AcDb::kForWrite);
	if (Acad::eOk != pVpTblRcd.openStatus())
