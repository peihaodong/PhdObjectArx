...
AcArray<CString> Phd::PhdArxTextStyle::GetAllTextStyleName(AcDbDatabase *pDb /*= acdbCurDwg()*/)
{
...
AcDbObjectId Phd::PhdArxTextStyle::GetTextStyleId(LPCTSTR szName, AcDbDatabase *pDb /*= acdbCurDwg()*/)
{
...
AcDbObjectId Phd::PhdArxTextStyle::GetTextStyleIdOfMText(const AcDbObjectId& idMText)
{
...
double Phd::PhdArxTextStyle::GetWidthScale(const AcDbObjectId& idTextStyle)
{
...
AcDbObjectIdArray Phd::PhdArxTextStyle::GetTextStyleIdsOnDb(AcDbDatabase* pDb)
{
