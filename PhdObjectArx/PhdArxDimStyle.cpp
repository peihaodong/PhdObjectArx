...
AcDbObjectId Phd::PhdArxDimStyle::GetDimStyleId(LPCTSTR szDimStyleName,AcDbDatabase* pDb /*= acdbCurDwg()*/)
{
...
AcDbObjectId Phd::PhdArxDimStyle::CreateDimStyle(AcDbDatabase* pDb /*= acdbCurDwg()*/)
{
...
AcDbObjectIdArray Phd::PhdArxDimStyle::GetDimStyleIdsOnDb(AcDbDatabase* pDb)
{
